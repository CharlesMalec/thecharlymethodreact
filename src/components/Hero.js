...
const Hero = () => (
  <section id="hero" className="relative bg-gradient-to-br from-indigo-50 to-blue-100 py-24 md:py-40 flex items-center justify-center text-center">
    <div className="container mx-auto px-4 z-10">
      <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-gray-900 leading-tight mb-4">The Charly Method</h1>
      ...
      <a href="#contact" className="px-8 py-4 bg-indigo-600 text-white font-semibold rounded-full shadow-xl hover:bg-indigo-700">Start Your Leadership Journey</a>
    </div>
  </section>
);

    ...
    <div className="container mx-auto px-4">
      ...
      <div className="grid md:grid-cols-3 gap-10">
        ...
        <div className="bg-white p-10 rounded-3xl shadow-lg services-card-hover">
          ...
          <h3 className="text-2xl font-semibold mb-3">Making Work Human: How Human-Centered Companies are Changing the Future of Work and the World</h3>
          ...
          <a href="https://amzn.to/3VtmQ58" target="_blank" rel="noopener noreferrer" className="inline-block px-6 py-3 bg-indigo-600 text-white font-semibold rounded-full hover:bg-indigo-700">
            Buy on Amazon
          </a>
        </div>
        <div className="bg-white p-10 rounded-3xl shadow-lg services-card-hover">
          ...
          <a href="https://amzn.to/4n7CAXj" target="_blank" rel="noopener noreferrer" className="inline-block px-6 py-3 bg-indigo-600 text-white font-semibold rounded-full hover:bg-indigo-700">
            Buy on Amazon
          </a>
        </div>
